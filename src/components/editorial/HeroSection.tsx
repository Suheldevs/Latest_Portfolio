      ...
      <div className="container-p" style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        >
          <div className="mono caps" style={{ color: "var(--ink-soft)" }}>
            Portfolio · Vol. II · {new Date().getFullYear()}
          </div>
          <div className="mono caps" style={{ color: "var(--ink-soft)" }}>
            <span
              style={{
        ...
        <div style={{ position: "relative", marginTop: "auto" }}>
          ...
          >
            ...
            <span style={{ display: "block" }}>
              <span style={{ fontStyle: "italic" }}>working</span> software.
            </span>
          </h1>
        </div>
        ...
        >
          <div>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 22, flexWrap: "wrap" }}>
              ...
              <a className="btn-p ghost" href={RESUME_URL} target="_blank" rel="noreferrer">
                Résumé, PDF{" "}
          ...
          <aside style={{ borderTop: "1px solid var(--ink)", paddingTop: 14 }}>
            <dl style={{ margin: 0, display: "grid", gridTemplateColumns: "auto 1fr", columnGap: 20, rowGap: 8, fontSize: 14 }}>
              ...
              <dd style={{ margin: 0 }}>Lucknow, India</dd>

              <dt className="mono caps" style={{ color: "var(--ink-faint)" }}>
                Now
              </dt>
              <dd style={{ margin: 0 }}>
                Associate Software Engineer at <span className="link-u">Jamtech Technologies</span>
              </dd>
              ...
              <dd style={{ margin: 0 }}>2024 — 2 years in production</dd>

              <dt className="mono caps" style={{ color: "var(--ink-faint)" }}>
                Contact
              </dt>
              <dd style={{ margin: 0 }}>
                <a className="link-u tap-pad" href="mailto:mohdsuhel.dev@gmail.com">
