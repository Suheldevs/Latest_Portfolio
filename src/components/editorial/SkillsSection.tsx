...
const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    items: [
      ...
      ["React Native + Expo, published builds", "Core"],
      ["Tailwind CSS, responsive systems", "Core"],
      ["Redux Toolkit & RTK Query", "Working"],
      ["GSAP animation, Chart.js dashboards", "Working"],
    ],
  },
  {
    title: "Backend",
    caption: "Node services behind four products",
    items: [
      ["Node.js (async patterns, streams)", "Core"],
      ["Express.js — middleware, error handling", "Core"],
      ["REST API design & versioning", "Core"],
      ["JWT auth, role-based access control", "Core"],
      ["Socket.io — real-time and presence", "Working"],
      ["Mongoose schemas, aggregation pipelines", "Working"],
    ],
  },
  {
    title: "Data & AI",
    ...
    items: [
      ["MongoDB & Atlas — modelling, indexes", "Core"],
      ["Firebase Auth & Firestore", "Core"],
      ["AI workflows and agent pipelines", "Working"],
      ["Vector search & embeddings", "Working"],
      ["Redis caching and sessions", "Working"],
      ["SQL — schema basics, joins", "Working"],
    ],
  },
  {
    ...
    items: [
      ["Git & GitHub, branch and PR discipline", "Core"],
      ["Shipping solo — spec to production", "Core"],
      ["Postman, API contract testing", "Core"],
      ["Vercel & Netlify deployment", "Working"],
      ["Razorpay and third-party integrations", "Working"],
      ["Working direct with clients on scope", "Working"],
    ],
  },
];
